...
namespace DataGridView_component
{
    class DataGridViewProgressCell : DataGridViewImageCell
    {
            ...
            DataGridViewPaintParts paintParts)
        {
            ...
            if (percentage >= 0.0)
            {
                ...
                if (this.ColumnIndex == 6 || this.ColumnIndex == 11)
                    g.FillRectangle(new SolidBrush(System.Drawing.Color.LightGreen), cellBounds.X + 2, cellBounds.Y + 2, Convert.ToInt32((percentage * cellBounds.Width * 0.8)), cellBounds.Height / 1 - 5);
                else
                    g.FillRectangle(new SolidBrush(System.Drawing.Color.HotPink), cellBounds.X + 2, cellBounds.Y + 2, Convert.ToInt32((percentage * cellBounds.Width * 0.8)), cellBounds.Height / 1 - 5);
